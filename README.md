<p align="center">
  <a href="https://github.com/Samadritaacharya">
    <picture>
...
- project charters, roadmaps, RAID and RACI governance
- stakeholder coordination, workshops, requirements and decision tracking
...
### SAP SE — Cloud Delivery Architecture / AIOps & Sovereign Cloud PMO
...
- Supported ITSM/ITOM delivery across incident, problem, change, request and NOC-style workflows.
- Used ServiceNow, Jira, Excel, SQL, Python and operational reporting to improve service visibility and process performance.
- Worked in international service environments with a focus on structured execution, documentation and change quality.

### Applied AI/ML research

- Developed deep-learning crop classification using multi-temporal satellite imagery at ISRO, achieving **92% classification accuracy**.
- Worked on ANN-based resource-management research at CSIR-CIMFR.
- Completed projects in connected mobility, Industry 4.0, quantitative analysis and AI-driven customer insights.

---

## Technical and delivery toolkit

**Project delivery:** Technical project coordination · PMO · RAID · RACI · stakeholder management · workshop facilitation · requirements · roadmaps · executive reporting

**Cloud and operations:** Cloud delivery · AIOps · observability concepts · ITSM/ITOM · incident · problem · change · request · SLA · service health

**Data and AI:** Python · SQL · Pandas · NumPy · scikit-learn · TensorFlow/Keras · Stata · Power BI · Plotly

**Build and collaboration:** Streamlit · GitHub Actions · Docker · Jira · ServiceNow · SharePoint · Excel · PowerPoint · Outlook · Teams
...
M.Sc. Management & Engineering — Technology, Innovation, Marketing & Entrepreneurship  
Final grade: **1.6** · Master’s thesis grade: **1.3**
